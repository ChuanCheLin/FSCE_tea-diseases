...
DATASET_ROOT_few = "/home/eric/mmdetection/data/VOCdevkit/datasets/set1/balanced1/" #need change
...
def setup(args):
    ...
    cfg.OUTPUT_DIR = "/home/eric/FSCE_tea-diseases/checkpoints/coco/faster_rcnn/set1/split2/1shot/"
